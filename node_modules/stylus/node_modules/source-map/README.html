<h1>Source Map</h1><p>This is a library to generate and consume the source map format
...
<h2>Examples</h2><h3>Consuming a source map</h3><pre><code>var rawSourceMap = {
  version: 3,
  file: &#39;min.js&#39;,
  names: [&#39;bar&#39;, &#39;baz&#39;, &#39;n&#39;],
...
</code></pre><h3>Generating a source map</h3><p>In depth guide:
...
<h4>With SourceNode (high level API)</h4><pre><code>function compile(ast) {
  switch (ast.type) {
...
</code></pre><h4>With SourceMapGenerator (low level API)</h4><pre><code>var map = new SourceMapGenerator({
...
</code></pre><h2>API</h2><p>Get a reference to the module:</p>
<pre><code>// NodeJS
...
</code></pre><h3>SourceMapConsumer</h3><p>A SourceMapConsumer instance represents a parsed source map which we can query
...
<h4>SourceMapConsumer.prototype.allGeneratedPositionsFor(originalPosition)</h4><p>Returns all generated line and column information for the original source
...
<h4>SourceMapConsumer.prototype.sourceContentFor(source)</h4><p>Returns the original source content for the source provided. The only
...
</code></pre><p>The new test will be located automatically when you run the suite.</p>
