<h2>2.0.6</h2><p>Version 2.0.4 adds support for React Native by clarifying in package.json that
the browser environment does not support Node.js domains.
Why this is necessary, we leave as an exercise for the user.</p>
<h2>2.0.3</h2><p>Version 2.0.3 fixes a bug when adjusting the capacity of the task queue.</p>
<h2>2.0.1-2.02</h2><p>Version 2.0.1 fixes a bug in the way redirects were expressed that affected the
function of Browserify, but which Mr would tolerate.</p>
<h2>2.0.0</h2><p>Version 2 of ASAP is a full rewrite with a few salient changes.
