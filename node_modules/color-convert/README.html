<h1>color-convert</h1><p><a href="https://travis-ci.org/Qix-/color-convert"><img src="https://travis-ci.org/Qix-/color-convert.svg?branch=master" alt="Build Status"></a></p>
...
<h1>Install</h1><pre><code class="language-console">$ npm install color-convert
</code></pre>
<h1>API</h1><p>Simply get the property of the <em>from</em> and <em>to</em> conversion that you&#39;re looking for.</p>
...
<h3>Arrays</h3><p>All functions that accept multiple arguments also support passing an array.</p>
...
<h1>Contribute</h1><p>If there is a new model you would like to support, or want to add a direct conversion between two existing models, please send us a pull request.</p>
<h1>License</h1><p>Copyright &copy; 2011-2016, Heather Arthur and Josh Junon. Licensed under the <a href="LICENSE">MIT License</a>.</p>
