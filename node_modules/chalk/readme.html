...
<li><a href="https://www.npmjs.com/browse/depended/chalk">Used by ~17,000 packages</a> as of June 20th, 2017</li>
</ul>
<h2>Install</h2><pre><code class="language-console">$ npm install chalk
</code></pre>
<h2>Usage</h2><pre><code class="language-js">const chalk = require(&#39;chalk&#39;);
...
<h3>chalk.enabled</h3><p>Color support is automatically detected, as is the level (see <code>chalk.level</code>). However, if you&#39;d like to simply enable/disable Chalk, you can do so via the <code>.enabled</code> property.</p>
<p>Chalk is enabled by default unless expicitly disabled via the constructor or <code>chalk.level</code> is <code>0</code>.</p>
...
<h3>chalk.level</h3><p>Color support is automatically detected, but you can override it by setting the <code>level</code> property. You should however only do this in your own code as it applies globally to all Chalk consumers.</p>
<p>If you need to change this in a reusable module, create a new instance:</p>
...
<h3>chalk.supportsColor</h3><p>Detect whether the terminal <a href="https://github.com/chalk/supports-color">supports color</a>. Used internally and handled for you, but exposed for convenience.</p>
...
<h2>Tagged template literal</h2><p>Chalk can be used as a <a href="http://exploringjs.com/es6/ch_template-literals.html#_tagged-template-literals">tagged template literal</a>.</p>
<pre><code class="language-js">const chalk = require(&#39;chalk&#39;);
...
<h2>256 and Truecolor color support</h2><p>Chalk supports 256 colors and <a href="https://gist.github.com/XVilka/8346728">Truecolor</a> (16 million colors) on supported terminal apps.</p>
...
<li><a href="https://en.wikipedia.org/wiki/HSL_and_HSV"><code>hsv</code></a> - Example: <code>chalk.hsl(32, 1, 1).bold(&#39;Orange!&#39;)</code></li>
<li><a href="https://en.wikipedia.org/wiki/HWB_color_model"><code>hwb</code></a>  - Example: <code>chalk.hsl(32, 0, 50).bold(&#39;Orange!&#39;)</code></li>
<li><code>ansi16</code></li>
<li><code>ansi256</code></li>
</ul>
<h2>Windows</h2><p>If you&#39;re on Windows, do yourself a favor and use <a href="http://cmder.net/"><code>cmder</code></a> instead of <code>cmd.exe</code>.</p>
<h2>Related</h2><ul>
