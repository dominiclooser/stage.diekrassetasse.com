<h1>argparse</h1><p><a href="http://travis-ci.org/nodeca/argparse"><img src="https://secure.travis-ci.org/nodeca/argparse.png?branch=master" alt="Build Status"></a></p>
...
<h1>Example</h1><p>test.js file:</p>
...
</code></pre><p>Parse arguments:</p>
<pre><code>$ ./test.js -f=3 --bar=4
{ foo: &#39;3&#39;, bar: &#39;4&#39; }
</code></pre><p>More <a href="https://github.com/nodeca/argparse/tree/master/examples">examples</a>.</p>
<h1>ArgumentParser objects</h1><pre><code>new ArgumentParser({paramters hash});
</code></pre><p>Creates a new ArgumentParser object.</p>
...
<h1>addArgument() method</h1><pre><code>ArgumentParser.addArgument([names or flags], {options})
</code></pre><p>Defines how a single command-line argument should be parsed.</p>
<ul>
...
<h1>Action (some details)</h1><p>ArgumentParser objects associate command-line arguments with actions.
...
<h1>Sub-commands</h1><p>ArgumentParser.addSubparsers()</p>
...
<h1>License</h1><p>Copyright (c) 2012 <a href="https://github.com/puzrin">Vitaly Puzrin</a>.
