...
<p><a href="https://travis-ci.org/sindresorhus/chalk"><img src="https://travis-ci.org/sindresorhus/chalk.svg?branch=master" alt="Build Status"></a> <a href="https://www.youtube.com/watch?v=Sm368W0OsHo"><img src="http://img.shields.io/badge/unicorn-approved-ff69b4.svg?style=flat" alt=""></a></p>
...
<p><img src="https://github.com/sindresorhus/ansi-styles/raw/master/screenshot.png" alt="screenshot"></p>
<h2>Why</h2><ul>
...
<li><a href="https://www.npmjs.com/browse/depended/chalk">Used by ~3000 modules</a></li>
</ul>
<h2>Install</h2><pre><code>$ npm install --save chalk
</code></pre><h2>Usage</h2><p>Chalk comes with an easy to use composable API where you just chain and nest the styles you want.</p>
...
<h2>API</h2><h3>chalk.<code>&lt;style&gt;[.&lt;style&gt;...](string, [string...])</code></h3><p>Example: <code>chalk.red.bold.underline(&#39;Hello&#39;, &#39;world&#39;);</code></p>
...
<h3>chalk.enabled</h3><p>Color support is automatically detected, but you can override it by setting the <code>enabled</code> property. You should however only do this in your own code as it applies globally to all chalk consumers.</p>
...
<h3>chalk.supportsColor</h3><p>Detect whether the terminal <a href="https://github.com/sindresorhus/supports-color">supports color</a>. Used internally and handled for you, but exposed for convenience.</p>
...
<h3>chalk.styles</h3><p>Exposes the styles as <a href="https://github.com/sindresorhus/ansi-styles">ANSI escape codes</a>.</p>
...
<h3>chalk.hasColor(string)</h3><p>Check whether a string <a href="https://github.com/sindresorhus/has-ansi">has color</a>.</p>
<h3>chalk.stripColor(string)</h3><p><a href="https://github.com/sindresorhus/strip-ansi">Strip color</a> from a string.</p>
...
<h2>Styles</h2><h3>Modifiers</h3><ul>
...
<h2>256-colors</h2><p>Chalk does not support support anything other than the base eight colors, which guarantees it will work on all terminals and systems. Some terminals, specifically <code>xterm</code> compliant ones, will support the full range of 8-bit colors. For this the lower level <a href="https://github.com/jbnicolai/ansi-256-colors">ansi-256-colors</a> package can be used.</p>
<h2>Windows</h2><p>If you&#39;re on Windows, do yourself a favor and use <a href="http://bliker.github.io/cmder/"><code>cmder</code></a> instead of <code>cmd.exe</code>.</p>
